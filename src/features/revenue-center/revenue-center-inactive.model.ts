...
export class RevenueCenterInactive extends Model {
...
RevenueCenterInactive.init(
  ...
  },
  {
    ...
    tableName: "TB_RevenueCenter_Inactive"
  }
);

RevenueCenterInactive.hasOne(CostCenterProject, {
  foreignKey: "idCostCenterProject",
  sourceKey: "idCostCenterProject"
});

RevenueCenterInactive.hasOne(RevenueCenterStatus, {
  foreignKey: "idRevenueCenterStatus",
  sourceKey: "idRevenueCenterStatus"
});

RevenueCenterInactive.hasOne(Quotation, {
