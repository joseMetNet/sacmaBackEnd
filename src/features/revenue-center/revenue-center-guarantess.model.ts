...
export class RevenueCenterRetentionGuarantee extends Model {
...
RevenueCenterRetentionGuarantee.init(
  {
    idRevenueCenter: {
  ...
  },
  {
    ...
    tableName: "TB_RevenueCenter_RetentionGuarantee"
  }
);

RevenueCenterRetentionGuarantee.hasOne(CostCenterProject, {
  foreignKey: "idCostCenterProject",
  sourceKey: "idCostCenterProject"
});

RevenueCenterRetentionGuarantee.hasOne(RevenueCenterStatus, {
  foreignKey: "idRevenueCenterStatus",
  sourceKey: "idRevenueCenterStatus"
});

RevenueCenterRetentionGuarantee.hasOne(Quotation, {
